...
const KeepBlogging = ({ invert }) => {
  return (
    ...
    >
      <p>
        Keep Blogging est une plateforme de blogging dédiée aux voyageurs. Elle
      ...
      <p>
        Techniquement, le framework React Next.js est utilisé pour le front-end.
        Le back-end est 100 % serverless, doté d'une API GraphQL et utilise le
        cloud d’infrastructure AWS. Cela permet une optimisation maximale des
        coûts, une mise à l’échelle illimitée et supprime la maintenance
